...
KEY_NAMES = [
    ...
    "mystery_key",
    "basement_key",
    "undead_asylum_f2_west_key",
    "annex_key",
    "watchtower_basement_key",
    "darkmoon_seance_ring",
    "key_to_new_londo_ruins",
    "cage_key",
    "archive_prison_extra_key",
    "archive_tower_giant_cell_key",
    "archive_tower_giant_door_key",
    "peculiar_doll",
    "broken_pendant",
    "crest_key",
    "crest_of_artorias",
...
def check_key_locations_are_valid(current_key_locations, rand_options):
            ...
            for area in current_areas:
                for key in connection_dict[area]:
                    if key in current_keys:
                        for area_to_add in (
                            set(connection_dict[area][key]) - current_areas
                        ):
    ...
    while has_changed:
        ...
        if (
            not speedrun
            and AREA.UNDEAD_PARISH in current_areas
            and AREA.QUELAAGS_DOMAIN in current_areas
            and AREA.SENS_FORTRESS not in current_areas
        ):
...
def get_connections(rand_options):
    ...
    if rand_options.key_placement == rng_opt.RandOptKeyDifficulty.SPEEDRUN_MODE:
        ...
        c[AREA.WATCHTOWER_BASEMENT]["none"] = [
            AREA.UNDEAD_BURG,
            AREA.DARKROOT_BASIN,  # Master Key
        ]
        c[AREA.UNDEAD_PARISH]["none"] += [AREA.SENS_FORTRESS]  # Sen's Gate Skip
        c[AREA.PAINTED_WORLD]["none"] += [AREA.PAINTED_WORLD_ANNEX]  # Annex Jump
        ...
        c[AREA.ANOR_LONDO]["none"] += [AREA.DARKMOON_TOMB]  # Gwynevere can be killed
        ...
        c[AREA.VALLEY_OF_DRAKES]["none"] += [AREA.NEW_LONDO_PRE_SEAL]  # Master Key
        c[AREA.DUKES_PRISON]["none"] = [AREA.DUKES_ARCHIVES]  # Duke Skip
    return c
...
CONNECTIONS = {
    ...
    AREA.UNDEAD_BURG_RESIDENCE: {"none": [AREA.UNDEAD_BURG]},
    ...
    AREA.PAINTED_WORLD_ANNEX: {"none": [AREA.PAINTED_WORLD]},
    AREA.DARKROOT_GARDEN: {"none": [AREA.DARKROOT_BASIN]},
    AREA.DARKROOT_FOREST: {
    ...
    AREA.OOLACILE_SANCTUARY: {"none": [AREA.ROYAL_WOOD]},
    AREA.ROYAL_WOOD: {"none": [AREA.OOLACILE_TOWNSHIP]},
    ...
    AREA.OOLACILE_HIDDEN: {"cast_light": [AREA.OOLACILE_TOWNSHIP]},
    AREA.KALAMEET_FIGHT: {"none": [AREA.ROYAL_WOOD]},
    AREA.CHASM_OF_THE_ABYSS: {"none": [AREA.ROYAL_WOOD, AREA.OOLACILE_TOWNSHIP]},
    AREA.CATACOMBS: {"none": [AREA.FIRELINK, AREA.TOMB_OF_THE_GIANTS_PRE_LV]},
    ...
    AREA.GREAT_HOLLOW: {"none": [AREA.BLIGHTTOWN, AREA.ASH_LAKE]},
    AREA.ASH_LAKE: {"none": [AREA.GREAT_HOLLOW]},
    AREA.BLIGHTTOWN: {
        "none": [AREA.VALLEY_OF_DRAKES, AREA.GREAT_HOLLOW, AREA.QUELAAGS_DOMAIN]
    },
    AREA.QUELAAGS_DOMAIN: {"none": [AREA.BLIGHTTOWN, AREA.DEMON_RUINS_NO_LAVA_PRE_LV]},
    ...
    AREA.DEMON_RUINS_LAVA: {"orange_charred_ring": [AREA.DEMON_RUINS_NO_LAVA_PRE_LV]},
    AREA.LOST_IZALITH: {
    ...
    AREA.SENS_CAGE: {"cage_key": [AREA.SENS_FORTRESS]},
    AREA.ANOR_LONDO: {
    ...
    AREA.DARKMOON_TOMB: {"none": [AREA.ANOR_LONDO]},
    ...
    AREA.NEW_LONDO_POST_LV: {"none": [AREA.NEW_LONDO_PRE_SEAL]},
    ...
    AREA.NEW_LONDO_POST_SEAL_SKIP: {"none": [], "covenant_of_artorias": []},
    AREA.VALLEY_OF_DRAKES: {
        "none": [AREA.BLIGHTTOWN, AREA.DARKROOT_BASIN],
        "key_to_new_londo_ruins": [AREA.NEW_LONDO_PRE_SEAL],
    },
    AREA.POST_4K: {"logic": [AREA.KILN], "lord_soul_shard_four_kings": []},
    AREA.DUKES_PRISON: {
    ...
    AREA.DUKES_PRISON_EXTRA: {"archive_prison_extra_key": [AREA.DUKES_PRISON]},
    AREA.DUKES_PRISON_GIANT_CELL: {"archive_tower_giant_cell_key": [AREA.DUKES_PRISON]},
    AREA.DUKES_ARCHIVES: {"none": [AREA.CRYSTAL_CAVE], "lordvessel": [AREA.ANOR_LONDO]},
    AREA.CRYSTAL_CAVE: {"none": [AREA.DUKES_ARCHIVES], "lord_soul_shard_seath": []},
    AREA.KILN: {},
    AREA.UNDEAD_ASYLUM: {
        "none": [AREA.FIRELINK],
        "undead_asylum_f2_west_key": [AREA.UNDEAD_ASYLUM_F2_WEST],
    },
    AREA.UNDEAD_ASYLUM_F2_WEST: {"none": [AREA.FIRELINK]},
    "starting": {"none": [AREA.UNDEAD_ASYLUM]},
}
