...
def make_difficulty_order_dict(
    ...
    MASTER_ORDER_DICT = {
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.EASY): {
            0: [loc_s.LOC_DIF.EASY, loc_s.LOC_DIF.MEDIUM, loc_s.LOC_DIF.HARD]
        },
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.MEDIUM): {
            0: [loc_s.LOC_DIF.EASY, loc_s.LOC_DIF.MEDIUM, loc_s.LOC_DIF.HARD]
        },
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.HARD): {
            0: [loc_s.LOC_DIF.EASY, loc_s.LOC_DIF.MEDIUM, loc_s.LOC_DIF.HARD]
        },
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.NPC_EASY): {
            0: [
                loc_s.LOC_DIF.NPC_EASY,
                loc_s.LOC_DIF.NPC_MEDIUM,
                loc_s.LOC_DIF.NPC_HARD,
            ]
        },
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.NPC_MEDIUM): {
            0: [
                loc_s.LOC_DIF.NPC_EASY,
                loc_s.LOC_DIF.NPC_MEDIUM,
                loc_s.LOC_DIF.NPC_HARD,
        ...
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.NPC_HARD): {
            0: [
                loc_s.LOC_DIF.NPC_EASY,
                loc_s.LOC_DIF.NPC_MEDIUM,
                loc_s.LOC_DIF.NPC_HARD,
        ...
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.SALABLE_EASY): {
            0: [
                loc_s.LOC_DIF.SHOP_EASY,
                loc_s.LOC_DIF.SHOP_MEDIUM,
                loc_s.LOC_DIF.SHOP_HARD,
            ]
        },
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.SALABLE_MEDIUM): {
            0: [
                loc_s.LOC_DIF.SHOP_EASY,
                loc_s.LOC_DIF.SHOP_MEDIUM,
                loc_s.LOC_DIF.SHOP_HARD,
        ...
        (rng_opt.RandOptDifficulty.EASY, item_s.ITEM_DIF.SALABLE_HARD): {
            0: [
                loc_s.LOC_DIF.SHOP_EASY,
                loc_s.LOC_DIF.SHOP_MEDIUM,
                loc_s.LOC_DIF.SHOP_HARD,
        ...
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.EASY): {
            0: [loc_s.LOC_DIF.EASY],
            1: [loc_s.LOC_DIF.MEDIUM, loc_s.LOC_DIF.HARD],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.MEDIUM): {
            0: [loc_s.LOC_DIF.MEDIUM],
            1: [loc_s.LOC_DIF.EASY, loc_s.LOC_DIF.HARD],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.HARD): {
            0: [loc_s.LOC_DIF.MEDIUM, loc_s.LOC_DIF.HARD],
            1: [loc_s.LOC_DIF.EASY],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.NPC_EASY): {
            0: [loc_s.LOC_DIF.NPC_EASY],
            1: [loc_s.LOC_DIF.NPC_MEDIUM, loc_s.LOC_DIF.NPC_HARD],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.NPC_MEDIUM): {
            0: [loc_s.LOC_DIF.NPC_MEDIUM],
            1: [loc_s.LOC_DIF.NPC_EASY, loc_s.LOC_DIF.NPC_HARD],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.NPC_HARD): {
            0: [loc_s.LOC_DIF.NPC_MEDIUM, loc_s.LOC_DIF.NPC_HARD],
            1: [loc_s.LOC_DIF.NPC_EASY],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.SALABLE_EASY): {
            0: [loc_s.LOC_DIF.SHOP_EASY],
            1: [loc_s.LOC_DIF.SHOP_MEDIUM, loc_s.LOC_DIF.SHOP_HARD],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.SALABLE_MEDIUM): {
            0: [loc_s.LOC_DIF.SHOP_MEDIUM],
            1: [loc_s.LOC_DIF.SHOP_EASY, loc_s.LOC_DIF.SHOP_HARD],
        },
        (rng_opt.RandOptDifficulty.MEDIUM, item_s.ITEM_DIF.SALABLE_HARD): {
            0: [loc_s.LOC_DIF.SHOP_MEDIUM, loc_s.LOC_DIF.SHOP_HARD],
            1: [loc_s.LOC_DIF.SHOP_EASY],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.EASY): {
            0: [loc_s.LOC_DIF.EASY],
            1: [loc_s.LOC_DIF.MEDIUM],
            2: [loc_s.LOC_DIF.HARD],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.MEDIUM): {
            0: [loc_s.LOC_DIF.MEDIUM],
            1: [loc_s.LOC_DIF.EASY, loc_s.LOC_DIF.HARD],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.HARD): {
            0: [loc_s.LOC_DIF.HARD],
            1: [loc_s.LOC_DIF.MEDIUM],
            2: [loc_s.LOC_DIF.EASY],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.NPC_EASY): {
            0: [loc_s.LOC_DIF.NPC_EASY],
            1: [loc_s.LOC_DIF.NPC_MEDIUM],
            2: [loc_s.LOC_DIF.NPC_HARD],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.NPC_MEDIUM): {
            0: [loc_s.LOC_DIF.NPC_MEDIUM],
            1: [loc_s.LOC_DIF.NPC_EASY, loc_s.LOC_DIF.NPC_HARD],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.NPC_HARD): {
            0: [loc_s.LOC_DIF.NPC_HARD],
            1: [loc_s.LOC_DIF.NPC_MEDIUM],
            2: [loc_s.LOC_DIF.NPC_EASY],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.SALABLE_EASY): {
            0: [loc_s.LOC_DIF.SHOP_EASY],
            1: [loc_s.LOC_DIF.SHOP_MEDIUM],
            2: [loc_s.LOC_DIF.SHOP_HARD],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.SALABLE_MEDIUM): {
            0: [loc_s.LOC_DIF.SHOP_MEDIUM],
            1: [loc_s.LOC_DIF.SHOP_EASY, loc_s.LOC_DIF.SHOP_HARD],
        },
        (rng_opt.RandOptDifficulty.HARD, item_s.ITEM_DIF.SALABLE_HARD): {
            0: [loc_s.LOC_DIF.SHOP_HARD],
            1: [loc_s.LOC_DIF.SHOP_MEDIUM],
            2: [loc_s.LOC_DIF.SHOP_EASY],
        },
    }
...
def eval_location_for_itemlotpart(
    ...
    if (
        loc.max_size != 9
        and len(itemlotpart.items) == 1
        and itemlotpart.items[0].item_type == item_s.ITEM_TYPE.NONE
    ):
        return False
    return True
...
def create_random_placement_list(
    ...
    for diff_val in sorted(list(difficulty_dict.keys())):
        ...
        temp_list = [
            ...
            if table.location_dict[loc_id].diff in diff_set
            and table.has_room_at_location_for_itemlotpart(
                itemlotpart_to_place, loc_id, item_list
            )
            and eval_location_for_itemlotpart(table, loc_id, itemlotpart_to_place)
        ]
...
def transmute_itemlotpart_to_rng_drop_upgrade(
    ...
    (upgrade_uncommon_id, upgrade_uncommon_count) = random_source.choice(
        sorted(item_s.RANDOM_UPGRADE_UNCOMMON)
    )
    (upgrade_rare_id, upgrade_rare_count) = random_source.choice(
        sorted(item_s.RANDOM_UPGRADE_RARE)
    )
    (upgrade_ultrarare_id, upgrade_ultrarare_count) = random_source.choice(
        sorted(item_s.RANDOM_UPGRADE_ULTRARARE)
    )

    entry_none = item_s.ItemLotEntry(item_s.ITEM_TYPE.NONE, 0, count=0, rate=10)
    entry_common = item_s.ItemLotEntry(
        item_s.ITEM_TYPE.ITEM,
        upgrade_common_id,
        count=upgrade_common_count,
        rate=30,
        luck=False,
    )
    entry_uncommon = item_s.ItemLotEntry(
        item_s.ITEM_TYPE.ITEM,
        upgrade_uncommon_id,
        count=upgrade_uncommon_count,
        rate=25,
        luck=False,
    )
    entry_rare = item_s.ItemLotEntry(
        item_s.ITEM_TYPE.ITEM,
        upgrade_rare_id,
        count=upgrade_rare_count,
        rate=20,
        luck=False,
    )
    entry_ultrarare = item_s.ItemLotEntry(
        item_s.ITEM_TYPE.ITEM,
        upgrade_ultrarare_id,
        count=upgrade_ultrarare_count,
        rate=15,
        luck=False,
    )
    ...
    log.debug(
        "Transmuting itemlotpart into RNG drop upgrade ("
        + str(upgrade_common_id)
        + " x"
        + str(upgrade_common_count)
        + ", "
        + str(upgrade_uncommon_id)
        + " x"
        + str(upgrade_uncommon_count)
        + ", "
        + str(upgrade_rare_id)
        + " x"
        + str(upgrade_rare_count)
        + ", "
        + str(upgrade_ultrarare_id)
        + " x"
        + str(upgrade_ultrarare_count)
        + ")"
    )
    return itemlotpart
...
def transmute_itemlotpart_to_consumable(
    ...
    log.debug(
        "Transmuting itemlotpart into consumable ("
        + str(cons_type)
        + ", "
        + str(cons_id)
        + ", "
...
def transmute_itemlotpart_to_boss_item(
    ...
    if itemlotpart.items:
        for itemlotentry in itemlotpart.items:
            if (
                itemlotentry.item_type == item_s.ITEM_TYPE.ITEM
                and itemlotentry.item_id in item_s.BOSS_SOUL_ITEMS
            ):
                if random_source.random() < 0.75:
                    boss_item_list_to_use = random_source.choice(
                        item_s.BOSS_SOUL_ITEMS[itemlotentry.item_id]
                    )
                    (boss_item_type, boss_item_id) = random_source.choice(
                        sorted(boss_item_list_to_use)
                    )
                    itemlotentry.item_type = boss_item_type
                    itemlotentry.item_id = boss_item_id
                    log.debug(
                        "Transmuting itemlotpart into boss item ("
                        + str(boss_item_type)
                        + ", "
                        + str(boss_item_id)
                        + ")"
...
def place_ignored_items(
    ...
    for loc_id in table.location_dict:
        loc = table.location_dict[loc_id]
        if loc.diff in [
            loc_s.LOC_DIF.IGNORE,
            loc_s.LOC_DIF.EMPTY,
            loc_s.LOC_DIF.LEAVE_ALONE,
        ]:
            log.debug(
                "Placing ignored item ID# "
                + str(loc_id)
                + " at location ID# "
                + str(loc_id)
            )
    ...
    for loc_id in table.location_dict:
        ...
        if loc.diff in [loc_s.LOC_DIF.UPGRADE, loc_s.LOC_DIF.RANDOM_UPGRADE]:
            ...
            if loc.diff == loc_s.LOC_DIF.UPGRADE:
                itemlotpart = transmute_itemlotpart_to_upgrade(
                    itemlotpart, random_source
                )
            if loc.diff == loc_s.LOC_DIF.RANDOM_UPGRADE:
                itemlotpart = transmute_itemlotpart_to_rng_drop_upgrade(
                    itemlotpart, random_source
                )
...
def place_key_items(
    ...
    if rand_options.key_placement == rng_opt.RandOptKeyDifficulty.LEAVE_ALONE:
        ...
        for key_name in key_items_s.KEY_NAMES:
            place_key_item_in_vanilla_location(
        ...
        if not rand_options.use_lordvessel:
            ...
            place_key_item_in_vanilla_location(
                table, "lordvessel", current_key_locations, item_list
            )
        if not rand_options.use_lord_souls:
            log.info("Placing Lord Souls in vanilla locations.")
            place_key_item_in_vanilla_location(
                table, "lord_soul_shard_seath", current_key_locations, item_list
            )
            place_key_item_in_vanilla_location(
                table, "lord_soul_shard_four_kings", current_key_locations, item_list
            )
            place_key_item_in_vanilla_location(
                table, "lord_soul_bed_of_chaos", current_key_locations, item_list
            )
            place_key_item_in_vanilla_location(
                table, "lord_soul_nito", current_key_locations, item_list
            )
        ...
        while not has_good_trial:
            ...
            keys_to_place = sorted(
                [
                    key
                    for key in trial_key_locations
                    if trial_key_locations[key] == "to_place"
                ]
            )
            used_loc_ids = set([])
            for key_name in keys_to_place:
                ...
                restricted_areas = key_items_s.get_key_restrictions(
                    key_name, rand_options
                )
                plausible_loc_ids = create_random_placement_list(
                    table,
                ...
                pre_possible_loc_ids = [
                    loc_id
                    for loc_id in plausible_loc_ids
                    if (
                        loc_id not in used_loc_ids
                        and table.location_dict[loc_id].area in restricted_areas
                    )
                    and not table.location_dict[loc_id].is_transient
                ]
                if (
                    rand_options.key_placement == rng_opt.RandOptKeyDifficulty.RACE_MODE
                    or rand_options.key_placement
                    == rng_opt.RandOptKeyDifficulty.SPEEDRUN_MODE
                ):
                    possible_loc_ids = [
                        loc_id
                        for loc_id in pre_possible_loc_ids
                        if table.location_dict[loc_id].is_race_key_loc
                    ]
                else:
                ...
                if len(possible_loc_ids) > 0:
                    ...
                    trial_key_locations[key_name] = table.location_dict[
                        possible_loc_ids[0]
                    ]
                else:
                    has_good_trial = False
            if has_good_trial:  # Nothing is wrong so far...
                has_good_trial = key_items_s.check_key_locations_are_valid(
                    trial_key_locations, rand_options
                )
        ...
        for key_name in trial_key_locations:
            if not key_items_s.key_placed(key_name, current_key_locations):
                ...
                table.place_itemlotpart_at_location(
                    key, loc.location_id, item_list, price=price_overwrite
                )
...
def get_price_for_difficulty(
    ...
    if diff not in shop_s.PRICE_DISTIBUTION:
        ...
        if itemlotpart.diff in [
            item_s.ITEM_DIF.SALABLE_EASY,
            item_s.ITEM_DIF.SALABLE_MEDIUM,
            item_s.ITEM_DIF.SALABLE_HARD,
        ]:
            min_price = shop_s.SALABLE_MIN_SELL_PRICE[
                (itemlotpart.items[0].item_type, itemlotpart.items[0].item_id)
            ]
...
def place_non_key_fixed_items(
    ...
    item_ids_to_place = [
        item_id
        for item_id in item_list
        if item_list[item_id].diff
        in [
            item_s.ITEM_DIF.EASY,
            item_s.ITEM_DIF.MEDIUM,
            item_s.ITEM_DIF.HARD,
            item_s.ITEM_DIF.SMALL_SOUL,
            item_s.ITEM_DIF.BIG_SOUL,
            item_s.ITEM_DIF.BOSS_SOUL,
            item_s.ITEM_DIF.NPC_EASY,
            item_s.ITEM_DIF.NPC_MEDIUM,
            item_s.ITEM_DIF.NPC_HARD,
            item_s.ITEM_DIF.SALABLE_EASY,
            item_s.ITEM_DIF.SALABLE_MEDIUM,
            item_s.ITEM_DIF.SALABLE_HARD,
        ]
    ...
    if rand_options.key_placement != rng_opt.RandOptKeyDifficulty.SPEEDRUN_MODE:
        item_ids_to_place += [
            ...
            for item_id in item_list
            if (
                item_list[item_id].diff == item_s.ITEM_DIF.KEY
                and item_list[item_id].key_name in key_items_s.ADDITIONAL_SPEEDRUN_KEYS
            )
        ]
    ...
    if rand_options.fashion_souls:
        ...
        for item_id in item_ids_to_place:
            if (
                ...
                and not item_s.ITEMS[item_id].always_follow_items
            ):
    ...
    following_items = set(
        f_item_id
        for item_id in item_ids_to_place
        for f_item_id in item_list[item_id].follow_items
    )
    item_ids_to_place = [
        item_id for item_id in item_ids_to_place if item_id not in following_items
    ]
    item_ids_to_place.sort(
        key=lambda item_id: item_list[item_id].get_max_effective_size(), reverse=True
    )
    ...
    for item_id in item_ids_to_place:
        ...
        if item.diff in [item_s.ITEM_DIF.SMALL_SOUL, item_s.ITEM_DIF.BIG_SOUL]:
            if (
                rand_options.soul_items_diff
                == rng_opt.RandOptSoulItemsDifficulty.CONSUMABLE
            ):
                item = transmute_itemlotpart_to_consumable(item, random_source)
        if item.diff == item_s.ITEM_DIF.BOSS_SOUL:
            if (
                rand_options.soul_items_diff
                == rng_opt.RandOptSoulItemsDifficulty.TRANSPOSE
            ):
        ...
        # Place item.
        possible_loc_ids = create_random_placement_list(
            table,
            make_difficulty_order_dict(rand_options.difficulty, item.diff),
            item,
            random_source,
            item_list,
        )
        if len(possible_loc_ids) > 0:
            ...
            price_overwrite = get_price_for_difficulty(
                table.location_dict[loc_id].diff, item, random_source
            )
            if price_overwrite != None:
                log.info(
                    "Placing ItemLotPart ID# "
                    + str(item_id)
                    + " at location ID# "
                    + str(loc_id)
                    + " with price "
            ...
            table.place_itemlotpart_at_location(
                item, loc_id, item_list, price=price_overwrite
            )
        else:
            log.warn(
                "Warning: Could not place ItemLotPart ID# "
                + str(item_id)
                + " during non-key fixed item placement."
            )
...
def place_starting_equipment(
    ...
    for start_class in loc_s.STARTING_ITEM_TABLE:
        for lot_type in ["left_hand", "right_hand", "extra"]:
            if (
                lot_type in loc_s.STARTING_ITEM_TABLE[start_class]
                and lot_type in data_passed_from_chr_init[start_class]
            ):
                ...
                for item_part in item_parts_to_place:
                    table.place_itemlotpart_at_location(
                        item_part, location_id, item_list
                    )
