...
PRICE_DISTIBUTION = {
    loc_s.LOC_DIF.EASY: [1, 10000] * 1
    + [10, 5000] * 4
    + [50, 250] * 5
    + [100, 200, 300, 750, 1000, 2000] * 10
    + [500] * 20,
    loc_s.LOC_DIF.MEDIUM: [300, 50000, 500000, 1000000] * 1
    + [500, 20000] * 3
    + [750, 17000] * 5
    + [1000, 2000, 3000, 7500, 10000, 15000] * 10
    + [5000] * 20,
    loc_s.LOC_DIF.HARD: [1000, 1000000] * 1
    + [2000, 100000] * 24
    + [4000, 50000, 75000] * 50
    + [5000, 7500, 10000, 15000, 30000, 40000] * 100
    + [20000] * 200,
    loc_s.LOC_DIF.SHOP_EASY: [20] * 15
    + [50] * 15
    + [100] * 40
    + [500] * 20
    + [1000] * 10
    + [2000] * 10,
    loc_s.LOC_DIF.SHOP_MEDIUM: [50] * 15
    + [100] * 15
    + [200] * 30
    + [500] * 20
    + [1000] * 10
    + [2000] * 5
    + [5000] * 5,
    loc_s.LOC_DIF.SHOP_HARD: [1000] * 10
    + [2000] * 10
    + [5000] * 20
    + [7500] * 20
    + [10000] * 20
